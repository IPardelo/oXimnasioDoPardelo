...
function ActiveWorkout() {
  ...
  useEffect(() => {
    ...
    const ping = active => {
      ...
      api('/api/activity.php', { method: 'POST', body: JSON.stringify({
    ...
    return () => {
      ...
      try { navigator.sendBeacon?.('/api/activity.php', new Blob([JSON.stringify({ active: false })], { type: 'application/json' })) } catch { /* */ }
      api('/api/activity.php', { method: 'POST', body: JSON.stringify({ active: false }) }).catch(() => {})
    }
  }, [])
