...
export default class ErrorBoundary extends Component {
  ...
  componentDidCatch(err) { console.error('O Ximnasio do Pardelo render error:', err) }
  ...
  render() {
    ...
    return (
      <div className="narrow">
        ...
        <Button variant="primary" icon="reset" onClick={() => location.reload()}>{t('Reload O Ximnasio do Pardelo')}</Button>
        {active && <>
          <div style={{ height: 8 }} />
