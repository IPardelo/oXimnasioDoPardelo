// O Ximnasio do Pardelo icon set — hand-drawn on a 24×24 grid, stroke-based, single weight.
//
...
const P = {
  ...
  /* ---- nutrition ---- */
  apple: <><circle cx="12" cy="13.6" r="7.4" /><path d="M12 6.2V4.4M12 4.4c.5-1.1 1.7-1.7 2.9-1.5" /></>,
  barcode: <path d="M4.6 5.4v13.2M7.4 5.4v13.2M9.8 5.4v13.2M13 5.4v13.2M15.4 5.4v13.2M19.4 5.4v13.2" />,
}
