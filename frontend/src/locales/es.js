...
export default {
  ...
  "This browser doesn't support passkeys — you can still use O Ximnasio do Pardelo locally on this device.": 'Este navegador no admite passkeys — aun así puedes usar O Ximnasio do Pardelo localmente en este dispositivo.',
  ...
  'Rest-timer alerts, even if O Ximnasio do Pardelo is closed.': 'Avisos del temporizador de descanso, incluso con O Ximnasio do Pardelo cerrado.',
  ...
  'A small file a friend imports into their own O Ximnasio do Pardelo — routines only, none of your workouts or weigh-ins.': 'Un archivo pequeño que un amigo importa en su propio O Ximnasio do Pardelo: solo rutinas, ninguno de tus entrenamientos ni pesajes.',
  ...
  'this isn’t a O Ximnasio do Pardelo plan file': 'esto no es un archivo de plan de O Ximnasio do Pardelo',
  'Shared routine': 'Rutina compartida',
  'Unknown exercise': 'Ejercicio desconocido',
  'Weekly Training Plan': 'Plan de entrenamiento semanal',
  'Made with O Ximnasio do Pardelo': 'Hecho con O Ximnasio do Pardelo',
  ...
  'Consumed': 'Consumidas',
  'remaining': 'restantes',
  'over your goal': 'por encima de tu objetivo',
  'Burned (exercise)': 'Quemadas (ejercicio)',
  'Calories burned (exercise)': 'Calorías quemadas (ejercicio)',
  ...
  'per {0}': 'por {0}',
  'unit': 'unidad',
  'Nothing here yet — log a few foods and they\'ll show up for quick re-adding.': 'Aún no hay nada aquí — registra algunos alimentos y aparecerán aquí para añadirlos rápido.',
  '{0} added': '{0} añadido',
  ...
  'By weight': 'Por peso',
  'By unit': 'Por unidad',
  'Unit name, e.g. "egg", "slice"': 'Nombre de la unidad, p. ej. "huevo", "loncha"',
  'Enter a unit name, e.g. "egg"': 'Introduce un nombre de unidad, p. ej. "huevo"',
  'Per 100 g / 100 ml': 'Por 100 g / 100 ml',
  'Per unit': 'Por unidad',
  'Standard serving (optional)': 'Ración estándar (opcional)',
  'Grams': 'Gramos',
  'Name, e.g. "1 cup"': 'Nombre, p. ej. "1 taza"',
  'Food created': 'Alimento creado',
  'No food saved with this barcode yet': 'Aún no hay ningún alimento guardado con este código de barras',
  'Camera access was denied': 'Se denegó el acceso a la cámara',
  'Could not start the camera': 'No se pudo iniciar la cámara',
  'Point the camera at a barcode': 'Apunta la cámara a un código de barras',
  ...
  'No recipes yet — group foods you eat often into a recipe you can log in one tap.': 'Aún no hay recetas — agrupa alimentos que comas a menudo en una receta que puedas registrar con un toque.',
}
